...
public class Credits {
    ...
    public static void initializeCredits() throws Exception {
        ...
        creditParts[11] = createTextCenteredWithShadow("Sounds: FreeSound.org", 1,1,1);
        creditParts[12] = create2DMesh(4.06349206349f,1f,"textures/freesound.png");

        creditParts[13] = createTextCenteredWithShadow("Java Library: LWJGL", 1,1,1);
        creditParts[14] = create2DMesh(2f,2f,"textures/lwjgl.png");
