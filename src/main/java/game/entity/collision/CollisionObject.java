...
final public class CollisionObject {
    ...
    final private double[] blockAABB  = new double[6];
    final private double[] entityAABB = new double[6];
    ...
    public void setAABBEntityFirst(double x, double y, double z, float width, float height){
    ...
    */
    ...
    public void setAABBBlock(float[] blockBox, int x, int y, int z){
    ...
    public void setAABBEntity(double x, double y, double z, float width, float height){
    ...
    public boolean pointIsWithinBlock(double x, double y, double z){
    ...
    public boolean pointIsWithinEntity(double x, double y, double z){
